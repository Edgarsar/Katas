...
function isValidWalk(walk) {
  const n = walk.filter(direction => direction === "n").length;
  const s = walk.filter(direction => direction === "s").length;
  const e = walk.filter(direction => direction === "e").length;
  const w = walk.filter(direction => direction === "w").length;
